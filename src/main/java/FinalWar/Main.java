...
public class Main extends Application {
    ...
    public void tell() {
        CalabashBroShowup(new Coordinate(12,4), "长蛇");
        LackeyShowup(new Coordinate(12,13), "方门");
    ...
    public void ready(){
        try {
            ...
            Button button2 = new Button("历史记录(X)");
            ...
            HBox hbox = new HBox();
            hbox.setSpacing(10);
            hbox.getChildren().addAll(button0,button1,button2,button3,button4,hbox1);
            hbox.setLayoutX(50);
            hbox.setLayoutY(5);
...
//            bp1.setLayoutX(0);
//            bp1.setLayoutY(40);
            ImageView bg = new ImageView(new Image("icons/Battle.jpg",1000,1000,true,true));
            bg.setLayoutX(0);
            bg.setLayoutY(40);
                ...
                if(obj_x - 1 >= 0)
                {
                    if(battleground.getSpot()[obj_x - 1][obj_y].SpotEmpty())
                    {
                        ...
                        if(obj.getQuality() == "Good") {
                            ...
                            //System.out.println(0 + " " + good.indexOf(obj) + " " + obj_x + " " + obj_y + " " + (obj_x - 1) + " " + obj_y);
                        }else {
                            RecordToFile(1, bad.indexOf(obj), obj_x, obj_y, obj_x - 1, obj_y,obj.getHp());
                            //System.out.println(1 + " " + bad.indexOf(obj) + " " + obj_x + " " + obj_y + " " + (obj_x - 1) + " " + obj_y);
                        }
                        break;
                    }
                }
                ...
                if(obj_y - 1 >= 0)
                {
                    if(battleground.getSpot()[obj_x][obj_y - 1].SpotEmpty())
                    {
                        ...
                        if(obj.getQuality() == "Good") {
                            ...
                            //System.out.println(0 + " " + good.indexOf(obj) + " " + obj_x + " " + obj_y + " " + obj_x + " " + (obj_y - 1));
                        }else {
                            RecordToFile(1, bad.indexOf(obj), obj_x, obj_y, obj_x, obj_y - 1,obj.getHp());
                            //System.out.println(1 + " " + bad.indexOf(obj) + " " + obj_x + " " + obj_y + " " + obj_x + " " + (obj_y - 1));
                        }
                        break;
                    }
                }
            ...
            if(ret == false) {
                ...
                if (fromy < toy) {
                    ...
                    if (battleground.getSpot()[fromx][fromy + 1].SpotEmpty()) {
                        ...
                        //System.out.println(0 + " " + good.indexOf(obj) + " " + fromx + " " + fromy + " " + fromx + " " + (fromy + 1));
                        do_flag = true;
                    }
                } else if (fromy > toy) {
                    ...
                    if (fromx < tox) {
                        ...
                        if (battleground.getSpot()[fromx + 1][fromy].SpotEmpty()) {
                            ...
                            //System.out.println(0 + " " + good.indexOf(obj) + " " + fromx + " " + fromy + " " + (fromx + 1) + " " + fromy);
                            do_flag = true;
                        }
                    } else if (fromx > tox) {
...
//            if(ret == true)
//                RecordToFile(1,bad.indexOf(obj),0,0,0,0);
            if(ret == false) {
                Random ran = new Random();
                int len = good.size();
                boolean conti = false;
                ...
                if (fromy < toy) {
                    if (battleground.getSpot()[fromx][fromy + 1].SpotEmpty()) {
                        ...
                        //System.out.println(1 + " " + bad.indexOf(obj) + " " + fromx + " " + fromy + " " + fromx + " " + (fromy + 1));
                        do_flag = true;
                    }
                } else if (fromy > toy) {
                    if (battleground.getSpot()[fromx][fromy - 1].SpotEmpty()) {
                    ...
                    if (fromx < tox) {
                        if (battleground.getSpot()[fromx + 1][fromy].SpotEmpty()) {
                            ...
                            //System.out.println(1 + " " + bad.indexOf(obj) + " " + fromx + " " + fromy + " " + (fromx + 1) + " " + fromy);
                            do_flag = true;
                        }
                    } else if (fromx > tox) {
                        if (battleground.getSpot()[fromx - 1][fromy].SpotEmpty()) {
    ...
    public synchronized boolean MoveByStep(String a)
    {
        ...
        try {
            ...
            Refresh(root);
            steps++;
            //System.out.println(" quality = " + quality + " index = " + index + " old_x = " + old_x + " old_y = " + old_y + " new_x = " + new_x + " new_y = " + new_y);
            //os.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        primaryStage.getIcons().add(new Image("icons/Title.jpg",50,50,true,true));
